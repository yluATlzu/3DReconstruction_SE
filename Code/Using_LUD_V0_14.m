function [PredRotations, volConstructed] = Using_LUD_V0_14( inputFileName, outputMRCFileName, apix, refqFileName)
...
%% Estimate orientations  using Least Squares method

log_message('Estimating projection angles using LUD');

PredRotations = est_orientations_LUD(clstack, n_theta);
